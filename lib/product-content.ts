...
export const PRODUCT_CONTENT: Record<string, ProductContent> = {
  ...
  "ai-automation-starter": {
    ...
    features: [
      ...
      },
      {
        ...
        title: "계약 기간 중 운영 지원",
        description:
          "계약 기간 동안 오류 대응과 정확도 개선을 지원해 안정적으로 정착시킵니다.",
      },
    ],
    specsTitle: "포함 내역",
    specs: [
    ...
    timeline: [
      ...
      },
      {
        period: "2개월차 (선택)",
        title: "운영 지원",
        description: "오류 대응, 예외 케이스 보완, 정확도 개선 (계약 연장 시)",
      },
    ],
    faqs: [
      {
      ...
      {
        q: "결제는 어떻게 이루어지나요?",
        a: "월 단위 용역이며 표시된 금액은 1개월 이용료입니다. 첫 달 이용료를 결제하면 담당자가 연락드려 계약 기간(1~2개월)을 협의하고, 다음 달부터는 매월 결제일에 발행되는 청구서를 마이페이지에서 결제합니다. 계약이 끝나면 더 이상 청구되지 않습니다.",
      },
      {
        q: "구축 후 별도 비용이 있나요?",
        a: "계약 기간 이용료 외에 회사가 청구하는 비용은 없습니다. AI 처리량에 따른 실비(API 비용 등)가 발생하는 구성이라면 진단 단계에서 예상 비용을 미리 안내해 드립니다.",
      },
      {
    ...
    caveats: [
      "표시된 금액은 1개월 이용료이며, 구매 시 첫 달 이용료만 결제됩니다. 다음 달부터는 매월 결제일에 청구서로 결제합니다.",
      "결제 후 영업일 1일 내 담당자가 연락드려 일정과 계약 기간을 협의하며, 진단 착수 이후에는 진행 단계에 따라 환불 금액이 달라집니다.",
      "AI API 사용료 등 외부 서비스 실비는 포함되어 있지 않으며, 발생 시 진단 단계에서 사전 안내합니다.",
      "절감 효과는 업무 특성과 데이터 품질에 따라 달라질 수 있으며, 특정 수치를 보장하지 않습니다.",
      "당사는 간이과세자로 세금계산서 발행이 불가하며, 카드 매출전표 또는 현금영수증(지출증빙용)으로 증빙됩니다. 계약서 기반(선금/잔금) 진행도 협의할 수 있습니다.",
    ],
  },
  ...
  "ai-automation-enterprise": {
    metrics: [
      ...
      { value: "1~3개월", label: "월 단위 용역 · 전담 매니저" },
    ],
    gallery: [
      {
    ...
    features: [
      ...
      },
      {
        ...
        title: "월간 성과 리포트",
        description:
          "매월 성과 리포트로 절감 시간과 개선 포인트를 보고하고 다음 달 과제를 정합니다.",
      },
    ],
    specsTitle: "포함 내역",
    specs: [
      ...
      { label: "운영 지원", value: "전담 매니저 배정 · 계약 기간 전체" },
    ...
    timeline: [
      {
        period: "1개월차",
        title: "전사 진단 · 우선 부서 구축",
        description: "부서별 업무 인터뷰, 자동화 로드맵·우선순위 수립, 효과가 큰 부서부터 구축 착수",
      },
      {
        period: "2개월차",
        title: "부서별 구축 · 시스템 연동",
        description: "나머지 부서 워크플로 구축, ERP·그룹웨어 연동, 1차 임직원 교육",
      },
      {
        period: "3개월차",
        title: "안정화 · 교육 · 이관",
        description: "통합 검수, 2차 임직원 교육, 운영 체계 이관, 최종 성과 리포트",
      },
      {
        period: "매월",
        title: "전담 매니저 운영 지원",
        description: "계약 기간 내내 오류 대응·변경 요청 관리·월간 성과 리포트 제공",
      },
    ],
    faqs: [
      {
      ...
      {
        q: "결제는 어떻게 이루어지나요?",
        a: "월 단위 용역이며 표시된 금액은 1개월 이용료입니다. 첫 달 이용료를 결제하면 담당 매니저가 연락드려 계약 기간(1~3개월)을 협의하고, 다음 달부터는 매월 결제일에 발행되는 청구서를 마이페이지에서 결제합니다. 계약이 끝나면 더 이상 청구되지 않습니다.",
      },
      {
        q: "계약·증빙 처리는 어떻게 되나요?",
        a: "온라인 월 결제 외에 계약서 기반 진행도 가능합니다. 당사는 간이과세자로 세금계산서 발행이 불가하며, 현금영수증(지출증빙용)은 요청 시 발행해 드립니다. 도입 문의로 연락 주세요.",
      },
      {
    ...
    caveats: [
      "표시된 금액은 1개월 이용료이며, 구매 시 첫 달 이용료만 결제됩니다. 다음 달부터는 매월 결제일에 청구서로 결제합니다.",
      "결제 후 영업일 1일 내 담당 매니저가 연락드려 일정과 계약 기간(1~3개월)을 협의하며, 진단 착수 이후에는 진행 단계에 따라 환불 금액이 달라집니다.",
      "AI API·클라우드 등 외부 서비스 실비와 ERP/그룹웨어 벤더 측 연동 비용은 포함되어 있지 않습니다.",
      "절감 효과는 업무 특성과 데이터 품질에 따라 달라질 수 있으며, 특정 수치를 보장하지 않습니다.",
      "온라인 월 결제 대신 계약서 기반 진행이 가능합니다. 당사는 간이과세자로 세금계산서 발행이 불가하며, 현금영수증(지출증빙용)으로 증빙됩니다. 도입 전 문의를 권장합니다.",
    ],
  },
};
...
export const AI_SERVICE_COMPARISON = {
  rows: [
    ...
    { label: "운영 지원", starter: "계약 기간 중", enterprise: "계약 기간 중 + 월간 리포트" },
    { label: "구축 기간", starter: "2~4주", enterprise: "1~3개월" },
  ],
};
