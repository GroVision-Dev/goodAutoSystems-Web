...
export const PRODUCT_CONTENT: Record<string, ProductContent> = {
  ...
  "ai-automation-enterprise": {
    ...
    faqs: [
      ...
      {
        q: "계약·증빙 처리는 어떻게 되나요?",
        a: "온라인 결제 외에 계약서 기반 진행(선금/잔금)도 가능합니다. 당사는 간이과세자로 세금계산서 발행이 불가하며, 현금영수증(지출증빙용)은 요청 시 발행해 드립니다. 도입 문의로 연락 주세요.",
      },
      {
    ...
    caveats: [
      ...
      "절감 효과는 업무 특성과 데이터 품질에 따라 달라질 수 있으며, 특정 수치를 보장하지 않습니다.",
      "온라인 결제 대신 계약서 기반(선금/잔금) 진행이 가능합니다. 당사는 간이과세자로 세금계산서 발행이 불가하며, 현금영수증(지출증빙용)으로 증빙됩니다. 도입 전 문의를 권장합니다.",
    ],
  },
};
